<html>
	...
	<div class="header" style="background-image:url(Images/header4.jpg); ">
			 <h3 ><span style="color:#ff0066;"> Send flowers<br> Like you mean it.<span/></h3>
		...
		<div class="card">
			<div class="row">		
				<div class="column" style="margin-top:50px; text-align: center;">
				
					<h2>Sing In</h2>			
		  
					<form style="border-style: ridge; margin:15px;padding:20px;">
						<label for="fname">First Name</label>
						<input type="text" id="fname" name="firstname" placeholder="Your name..">

						<label for="pasword">Pasword</label>
						<input type="pasword" id="pasword" name="pasword" placeholder="">  
				...
				<div class="column" style="margin:45px;   width:50%; " >
